    ...
    Animation loadAnimation(Fragment fragment, int transit, boolean enter, int transitionStyle) {
        ...
        switch (styleIndex) {
            case ANIM_STYLE_OPEN_ENTER /*1*/:
                return makeOpenCloseAnimation(this.mActivity, 1.125f, AugmentedReality.ONE_PERCENT, 0.0f, AugmentedReality.ONE_PERCENT);
            case ANIM_STYLE_OPEN_EXIT /*2*/:
                return makeOpenCloseAnimation(this.mActivity, AugmentedReality.ONE_PERCENT, 0.975f, AugmentedReality.ONE_PERCENT, 0.0f);
            case ANIM_STYLE_CLOSE_ENTER /*3*/:
                return makeOpenCloseAnimation(this.mActivity, 0.975f, AugmentedReality.ONE_PERCENT, 0.0f, AugmentedReality.ONE_PERCENT);
            case ANIM_STYLE_CLOSE_EXIT /*4*/:
                return makeOpenCloseAnimation(this.mActivity, AugmentedReality.ONE_PERCENT, 1.075f, AugmentedReality.ONE_PERCENT, 0.0f);
            case ANIM_STYLE_FADE_ENTER /*5*/:
                return makeFadeAnimation(this.mActivity, 0.0f, AugmentedReality.ONE_PERCENT);
            case ANIM_STYLE_FADE_EXIT /*6*/:
                return makeFadeAnimation(this.mActivity, AugmentedReality.ONE_PERCENT, 0.0f);
            default:
