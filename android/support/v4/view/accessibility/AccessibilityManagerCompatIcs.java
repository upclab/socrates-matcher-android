...
class AccessibilityManagerCompatIcs {
    ...
    static class C00121 implements AccessibilityStateChangeListener {
        final /* synthetic */ AccessibilityStateChangeListenerBridge val$bridge;

        C00121(AccessibilityStateChangeListenerBridge accessibilityStateChangeListenerBridge) {
