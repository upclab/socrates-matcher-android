...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    class C00063 extends FutureTask<Result> {
        C00063(Callable x0) {
            super(x0);
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C04302();
        this.mFuture = new C00063(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
        if (this.mStatus != Status.PENDING) {
            switch (C00074.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
