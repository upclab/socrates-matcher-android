...
public class UnderlinePageIndicator extends View implements PageIndicator {
    ...
    static class SavedState extends BaseSavedState {
        ...
        class C03791 implements Creator<SavedState> {
            C03791() {
            }
    ...
    public UnderlinePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, C0373R.attr.vpiUnderlinePageIndicatorStyle);
    }
    ...
    public UnderlinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mFadeRunnable = new C03771();
        if (!isInEditMode()) {
            Resources res = getResources();
            boolean defaultFades = res.getBoolean(C0373R.bool.default_underline_indicator_fades);
            int defaultFadeDelay = res.getInteger(C0373R.integer.default_underline_indicator_fade_delay);
            int defaultFadeLength = res.getInteger(C0373R.integer.default_underline_indicator_fade_length);
            int defaultSelectedColor = res.getColor(C0373R.color.default_underline_indicator_selected_color);
            TypedArray a = context.obtainStyledAttributes(attrs, C0373R.styleable.UnderlinePageIndicator, defStyle, 0);
            setFades(a.getBoolean(1, defaultFades));
            setSelectedColor(a.getColor(0, defaultSelectedColor));
            setFadeDelay(a.getInteger(2, defaultFadeDelay));
            setFadeLength(a.getInteger(3, defaultFadeLength));
            a.recycle();
    ...
    public void setFadeLength(int fadeLength) {
        ...
        this.mFadeBy = MotionEventCompat.ACTION_MASK / (this.mFadeLength / FADE_FRAME_MS);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.mViewPager != null) {
            ...
            float pageWidth = ((float) ((getWidth() - paddingLeft) - getPaddingRight())) / (AugmentedReality.ONE_PERCENT * ((float) count));
