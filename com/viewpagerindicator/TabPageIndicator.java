...
public class TabPageIndicator extends HorizontalScrollView implements PageIndicator {
    ...
    private class TabView extends TextView {
        ...
        public TabView(Context context) {
            super(context, null, C0373R.attr.vpiTabPageIndicatorStyle);
            init();
        }
        ...
        public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (TabPageIndicator.this.mMaxTabWidth > 0 && getMeasuredWidth() > TabPageIndicator.this.mMaxTabWidth) {
                super.onMeasure(MeasureSpec.makeMeasureSpec(TabPageIndicator.this.mMaxTabWidth, Ints.MAX_POWER_OF_TWO), heightMeasureSpec);
            }
        }
        ...
        private void init() {
            setTypeface(Typeface.createFromAsset(getContext().getAssets(), "fonts/Zizou Slab-Regular.otf"));
            setTextColor(Color.parseColor("#535353"));
            setTextSize(AugmentedReality.TEN_PERCENT);
        }
    }

    static {
        EMPTY_TITLE = StringUtils.EMPTY;
    }
    ...
    public TabPageIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mTabClickListener = new C03741();
    ...
    private void animateToTab(int position) {
        ...
        this.mTabSelector = new C03752(tabView);
    ...
    private void addTab(CharSequence text, int index) {
        ...
        this.mTabLayout.addView(tabView, new LinearLayout.LayoutParams(0, -1, AugmentedReality.ONE_PERCENT));
    }
