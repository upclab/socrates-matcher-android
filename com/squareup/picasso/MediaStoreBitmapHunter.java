...
class MediaStoreBitmapHunter extends ContentStreamBitmapHunter {
    ...
    enum PicassoKind {
        MICRO(3, 96, 96),
        MINI(1, AccessibilityEventCompat.TYPE_TOUCH_EXPLORATION_GESTURE_START, 384),
        FULL(2, -1, -1);
    ...
    static int getExitOrientation(android.content.ContentResolver r9, android.net.Uri r10) {
...
*/
    ...
    L_0x0035:
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.squareup.picasso.MediaStoreBitmapHunter.getExitOrientation(android.content.ContentResolver, android.net.Uri):int");
    }
    ...
    Bitmap decode(Request data) throws IOException {
        ...
        if (data.hasSize()) {
            ...
            Bitmap result = Thumbnails.getThumbnail(contentResolver, id, picassoKind.androidKind, options);
            if (result != null) {
                return result;
            }
        }
