...
public class Picasso {
    ...
    static class C03671 extends Handler {
        C03671(Looper x0) {
            super(x0);
        }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case Value.INTEGER_FIELD_NUMBER /*8*/:
                    for (BitmapHunter hunter : msg.obj) {
    ...
    public static class Builder {
        ...
        public Picasso build() {
            ...
            return new Picasso(context, new Dispatcher(context, this.service, Picasso.HANDLER, this.downloader, this.cache, stats), this.cache, this.listener, this.transformer, stats, this.debugging);
        }
    }
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    this.handler.post(new C03681(e2));
                    return;
                }
            }
        }
    ...
    public interface RequestTransformer {
        ...
        static class C08591 implements RequestTransformer {
            C08591() {
            }
    ...
    static {
        HANDLER = new C03671(Looper.getMainLooper());
        singleton = null;
    }

    Picasso(Context context, Dispatcher dispatcher, Cache cache, Listener listener, RequestTransformer requestTransformer, Stats stats, boolean debugging) {
