...
public class EasyTracker extends Tracker {
    ...
    private void loadParameters() {
        ...
        if (logLevelString != null) {
            ...
            if (logLevel != null) {
                Log.m3v("[EasyTracker] log level loaded: " + logLevel);
        ...
        Log.m3v("[EasyTracker] sample rate loaded: " + sampleRate);
        int dispatchPeriod = this.mParameterFetcher.getInt("ga_dispatchPeriod", 1800);
        Log.m3v("[EasyTracker] dispatch period loaded: " + dispatchPeriod);
        ...
        Log.m3v("[EasyTracker] session timeout loaded: " + this.mSessionTimeout);
        ...
        Log.m3v("[EasyTracker] auto activity tracking loaded: " + this.mIsAutoActivityTracking);
        ...
        if (isAnonymizeIpEnabled) {
            ...
            Log.m3v("[EasyTracker] anonymize ip loaded: " + isAnonymizeIpEnabled);
        }
        ...
        if (this.mIsReportUncaughtExceptionsEnabled) {
            ...
            Log.m3v("[EasyTracker] report uncaught exceptions loaded: " + this.mIsReportUncaughtExceptionsEnabled);
        }
    ...
    private void setContext(Context ctx, ParameterLoader parameterLoader, ServiceManager serviceManager) {
        if (ctx == null) {
            Log.m1e("Context cannot be null");
        }
