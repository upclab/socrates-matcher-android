...
public class ContainerOpener {
    ...
    class C03293 extends TimerTask {
        C03293() {
        }

        public void run() {
            Log.m608i("Timer expired.");
    ...
    static class C08422 implements Notifier {
        final /* synthetic */ ContainerFutureImpl val$future;

        C08422(ContainerFutureImpl containerFutureImpl) {
    ...
    public static ContainerFuture openContainer(TagManager tagManager, String containerId, OpenType openType, Long timeoutInMillis) {
        ...
        openContainer(tagManager, containerId, openType, timeoutInMillis, new C08422(future));
        return future;
    }
    ...
    private void setTimer(long timeoutInMillis) {
        new Timer("ContainerOpener").schedule(new C03293(), timeoutInMillis);
    }
