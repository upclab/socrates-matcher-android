...
class HitSendingThreadImpl extends Thread implements HitSendingThread {
    ...
    class C03301 implements Runnable {
        ...
        C03301(HitSendingThread hitSendingThread, long j, String str) {
    ...
    void sendHit(String url, long hitTime) {
        queueToThread(new C03301(this, hitTime, url));
    }
    ...
    public void run() {
        while (!this.mClosed) {
            try {
                ...
                Log.m608i(e.toString());
            } catch (Throwable t) {
                Log.m606e("Error on GAThread: " + printStackTrace(t));
                Log.m606e("Google Analytics is shutting down.");
                this.mDisabled = true;
            }
        }
    }
