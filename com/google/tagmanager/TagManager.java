...
public class TagManager {
    ...
    class C08511 implements Listener {
        C08511() {
        }
    ...
    static class C08522 implements ContainerProvider {
        C08522() {
        }
    ...
    TagManager(Context context, ContainerProvider containerProvider, DataLayer dataLayer) {
        ...
        this.mDataLayer.registerListener(new C08511());
    ...
    public static TagManager getInstance(Context context) {
        ...
        synchronized (TagManager.class) {
            if (sInstance == null) {
                sInstance = new TagManager(context, new C08522(), new DataLayer());
            }
    ...
    L_0x000b:
        ...
        r6 = com.google.tagmanager.TagManager.C03403.$SwitchMap$com$google$tagmanager$PreviewManager$PreviewMode;	 Catch:{ all -> 0x0033 }
