...
class RopeByteString extends ByteString {
    ...
    static ByteString concatenate(ByteString left, ByteString right) {
        ...
        if (newLength < AccessibilityEventCompat.TYPE_VIEW_HOVER_ENTER) {
            return concatenateBytes(left, right);
        }
        if (leftRope != null && leftRope.right.size() + right.size() < AccessibilityEventCompat.TYPE_VIEW_HOVER_ENTER) {
