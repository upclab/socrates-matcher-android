...
public final class CodedOutputStream {
    ...
    public void writeStringNoTag(String value) throws IOException {
        byte[] bytes = value.getBytes(CharEncoding.UTF_8);
    ...
    public void writeRawVarint32(int value) throws IOException {
        while ((value & -128) != 0) {
            writeRawByte((value & 127) | AccessibilityEventCompat.TYPE_VIEW_HOVER_ENTER);
            value >>>= 7;
        }
        writeRawByte(value);
    }
    ...
    public void writeRawVarint64(long value) throws IOException {
        while ((-128 & value) != 0) {
            writeRawByte((((int) value) & 127) | AccessibilityEventCompat.TYPE_VIEW_HOVER_ENTER);
            value >>>= 7;
        }
