...
class InstallReferrerUtil {
        ...
        if (installReferrer == null) {
            synchronized (InstallReferrerUtil.class) {
                if (installReferrer == null) {
                    ...
                    if (settings != null) {
                        installReferrer = settings.getString(PREF_KEY_REFERRER, StringUtils.EMPTY);
                    } else {
                        installReferrer = StringUtils.EMPTY;
                    }
                }
            }
        }
    ...
    static String getClickReferrer(Context context, String conversionId, String component) {
        ...
        if (referrer == null) {
            ...
            if (settings != null) {
                referrer = settings.getString(conversionId, StringUtils.EMPTY);
            } else {
                referrer = StringUtils.EMPTY;
            }
            clickReferrers.put(conversionId, referrer);
        }
