...
public final class IntMath {
    ...
    public static int log2(int x, RoundingMode mode) {
        ...
        switch (C02861.$SwitchMap$java$math$RoundingMode[mode.ordinal()]) {
    ...
    static {
        ...
        powersOf10 = new int[]{1, 10, 100, DateTimeConstants.MILLIS_PER_SECOND, Const.SOCKET_TIMEOUT, 100000, 1000000, 10000000, 100000000, 1000000000};
