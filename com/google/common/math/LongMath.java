...
public final class LongMath {
    ...
    public static int log2(long x, RoundingMode mode) {
        ...
        switch (C02871.$SwitchMap$java$math$RoundingMode[mode.ordinal()]) {
    ...
    static {
        ...
        biggestBinomials = new int[]{Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 3810779, 121977, 16175, 4337, 1733, 887, 534, 361, 265, 206, 169, 143, 125, 111, ServingValue.EXT_FIELD_NUMBER, 94, 88, 83, 79, 76, 74, 72, 70, 69, 68, 67, 67, 66, 66, 66, 66};
        biggestSimpleBinomials = new int[]{Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 2642246, 86251, 11724, 3218, 1313, 684, 419, 287, 214, 169, 139, 119, LocationRequest.PRIORITY_NO_POWER, 95, 87, 81, 76, 73, 70, 68, 66, 64, 63, 62, 62, 61, 61, 61};
    }
    ...
    public static long gcd(long a, long b) {
        ...
        MathPreconditions.checkNonNegative(AdView.AD_ORIENTATION_BOTH, b);
        if (a == 0) {
            return b;
        }
        if (b == 0) {
