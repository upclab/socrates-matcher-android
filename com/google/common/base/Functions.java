...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        private static final long serialVersionUID = 0;
        private final Function<A, ? extends B> f136f;
        private final Function<B, C> f137g;

        public FunctionComposition(Function<B, C> g, Function<A, ? extends B> f) {
            this.f137g = (Function) Preconditions.checkNotNull(g);
            this.f136f = (Function) Preconditions.checkNotNull(f);
        }

        public C apply(@Nullable A a) {
            return this.f137g.apply(this.f136f.apply(a));
        }
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            if (this.f136f.equals(that.f136f) && this.f137g.equals(that.f137g)) {
                return true;
            }
            return false;
        }
        ...
        public int hashCode() {
            return this.f136f.hashCode() ^ this.f137g.hashCode();
        }

        public String toString() {
            return this.f137g.toString() + "(" + this.f136f.toString() + ")";
        }
    }
