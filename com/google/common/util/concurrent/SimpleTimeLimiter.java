...
public final class SimpleTimeLimiter implements TimeLimiter {
    ...
    class C03251 implements InvocationHandler {
        ...
        class C03241 implements Callable<Object> {
            final /* synthetic */ Object[] val$args;
            final /* synthetic */ Method val$method;

            C03241(Method method, Object[] objArr) {
            ...
            public Object call() throws Exception {
                try {
                    return this.val$method.invoke(C03251.this.val$target, this.val$args);
        ...
        C03251(Object obj, long j, TimeUnit timeUnit, Set set) {
            this.val$target = obj;
        ...
        public Object invoke(Object obj, Method method, Object[] args) throws Throwable {
            return SimpleTimeLimiter.this.callWithTimeout(new C03241(method, args), this.val$timeoutDuration, this.val$timeoutUnit, this.val$interruptibleMethods.contains(method));
        }
    }
    ...
    public <T> T newProxy(T target, Class<T> interfaceType, long timeoutDuration, TimeUnit timeoutUnit) {
        ...
        return newProxy(interfaceType, new C03251(target, timeoutDuration, timeoutUnit, findInterruptibleMethods(interfaceType)));
    }
