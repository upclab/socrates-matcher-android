...
public final class MediaType {
    ...
    class C07811 implements Function<Collection<String>, ImmutableMultiset<String>> {
        C07811() {
        }
    ...
    class C07822 implements Function<String, String> {
        C07822() {
        }
    ...
    private Map<String, ImmutableMultiset<String>> parametersAsMap() {
        return Maps.transformValues(this.parameters.asMap(), new C07811());
    }
    ...
    public String toString() {
        ...
        if (!this.parameters.isEmpty()) {
            builder.append("; ");
            PARAMETER_JOINER.appendTo(builder, Multimaps.transformValues(this.parameters, new C07822()).entries());
        }
