...
public class LittleEndianDataOutputStream extends FilterOutputStream implements DataOutput {
    ...
    public void writeInt(int v) throws IOException {
        this.out.write(v & MotionEventCompat.ACTION_MASK);
        this.out.write((v >> 8) & MotionEventCompat.ACTION_MASK);
        this.out.write((v >> 16) & MotionEventCompat.ACTION_MASK);
        this.out.write((v >> 24) & MotionEventCompat.ACTION_MASK);
    }
