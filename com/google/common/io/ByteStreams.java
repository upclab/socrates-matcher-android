...
public final class ByteStreams {
    ...
    static class C02791 extends OutputStream {
        C02791() {
        }
    ...
    static class C07712 implements Function<InputSupplier<? extends InputStream>, ByteSource> {
        C07712() {
        }
    ...
    static class C10313 extends ByteSource {
        final /* synthetic */ InputSupplier val$supplier;

        C10313(InputSupplier inputSupplier) {
    ...
    static class C10324 extends ByteSink {
        final /* synthetic */ OutputSupplier val$supplier;

        C10324(OutputSupplier outputSupplier) {
    ...
    public static InputSupplier<InputStream> join(Iterable<? extends InputSupplier<? extends InputStream>> suppliers) {
        ...
        return asInputSupplier(ByteSource.concat(Iterables.transform(suppliers, new C07712())));
    }
