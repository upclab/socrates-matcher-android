...
public abstract class HashCode {
    ...
    private static final class BytesHashCode extends HashCode implements Serializable {
        ...
        public int asInt() {
            ...
            return (((this.bytes[0] & MotionEventCompat.ACTION_MASK) | ((this.bytes[1] & MotionEventCompat.ACTION_MASK) << 8)) | ((this.bytes[2] & MotionEventCompat.ACTION_MASK) << 16)) | ((this.bytes[3] & MotionEventCompat.ACTION_MASK) << 24);
        }
        ...
        public long padToLong() {
            long retVal = (long) (this.bytes[0] & MotionEventCompat.ACTION_MASK);
    ...
    public final int hashCode() {
        ...
        byte[] bytes = asBytes();
        int val = bytes[0] & MotionEventCompat.ACTION_MASK;
        for (int i = 1; i < bytes.length; i++) {
            val |= (bytes[i] & MotionEventCompat.ACTION_MASK) << (i * 8);
        }
        return val;
    }
