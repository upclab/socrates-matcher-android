...
class StandardTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    private class Column extends ImprovedAbstractMap<R, V> {
        ...
        private class EntrySetIterator extends AbstractIterator<Entry<R, V>> {
            ...
            class C07461 extends AbstractMapEntry<R, V> {
    ...
    private class ColumnMap extends ImprovedAbstractMap<C, Map<R, V>> {
        ...
        class ColumnMapEntrySet extends TableSet<Entry<C, Map<R, V>>> {
            ...
            class C07471 implements Function<C, Map<R, V>> {
                C07471() {
                }
            ...
            public Iterator<Entry<C, Map<R, V>>> iterator() {
                return Maps.asMapEntryIterator(StandardTable.this.columnKeySet(), new C07471());
            }
    ...
    class Row extends ImprovedAbstractMap<C, V> {
        ...
        private final class RowEntrySet extends EntrySet<C, V> {
            ...
            class C02611 implements Iterator<Entry<C, V>> {
                final /* synthetic */ Iterator val$iterator;

                /* renamed from: com.google.common.collect.StandardTable.Row.RowEntrySet.1.1 */
                class C10081 extends ForwardingMapEntry<C, V> {
                    final /* synthetic */ Entry val$entry;
                ...
                public Entry<C, V> next() {
                    return new C10081((Entry) this.val$iterator.next());
                }
            ...
            public Iterator<Entry<C, V>> iterator() {
                ...
                return new C02611(map.entrySet().iterator());
            }
        }
    ...
    class RowMap extends ImprovedAbstractMap<R, Map<C, V>> {
        ...
        class EntrySet extends TableSet<Entry<R, Map<C, V>>> {
            ...
            class C07481 implements Function<R, Map<C, V>> {
                C07481() {
                }
            ...
            public Iterator<Entry<R, Map<C, V>>> iterator() {
                return Maps.asMapEntryIterator(StandardTable.this.backingMap.keySet(), new C07481());
            }
