...
public class TreeBasedTable<R, C, V> extends StandardRowSortedTable<R, C, V> {
    ...
    class C07541 implements Function<Map<C, V>, Iterator<C>> {
        C07541() {
        }
    ...
    class C10122 extends AbstractIterator<C> {
        C lastValue;
        final /* synthetic */ Comparator val$comparator;
        final /* synthetic */ Iterator val$merged;

        C10122(Iterator it, Comparator comparator) {
            this.val$merged = it;
    ...
    Iterator<C> createColumnKeyIterator() {
        ...
        return new C10122(Iterators.mergeSorted(Iterables.transform(this.backingMap.values(), new C07541()), comparator), comparator);
    }
}
