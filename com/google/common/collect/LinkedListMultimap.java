...
public class LinkedListMultimap<K, V> extends AbstractMultimap<K, V> implements ListMultimap<K, V>, Serializable {
    ...
    class C02441 extends AbstractSequentialList<V> {
    ...
    class C02453 extends AbstractSequentialList<V> {

        /* renamed from: com.google.common.collect.LinkedListMultimap.3.1 */
        class C09721 extends TransformedListIterator<Entry<K, V>, V> {
            final /* synthetic */ NodeIterator val$nodeItr;

            C09721(ListIterator x0, NodeIterator nodeIterator) {
        ...
        public ListIterator<V> listIterator(int index) {
            ...
            return new C09721(nodeItr, nodeItr);
        }
    }

    /* renamed from: com.google.common.collect.LinkedListMultimap.4 */
    class C02464 extends AbstractSequentialList<Entry<K, V>> {
        C02464() {
        }
    ...
    class C06872 extends ImprovedAbstractSet<K> {
        C06872() {
        }
