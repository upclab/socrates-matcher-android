...
public final class ArrayTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    private static abstract class ArrayMap<K, V> extends ImprovedAbstractMap<K, V> {
        ...
        class C09501 extends EntrySet<K, V> {

            /* renamed from: com.google.common.collect.ArrayTable.ArrayMap.1.1 */
            class C10771 extends AbstractIndexedListIterator<Entry<K, V>> {

                /* renamed from: com.google.common.collect.ArrayTable.ArrayMap.1.1.1 */
                class C06561 extends AbstractMapEntry<K, V> {
    ...
    class C10761 extends AbstractIndexedListIterator<Cell<R, C, V>> {

        /* renamed from: com.google.common.collect.ArrayTable.1.1 */
        class C09491 extends AbstractCell<R, C, V> {
            final int columnIndex;
            final int rowIndex;
            final /* synthetic */ int val$index;
