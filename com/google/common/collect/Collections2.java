...
public final class Collections2 {
    ...
    static class C06611 implements Function<Object, Object> {
        final /* synthetic */ Collection val$collection;

        C06611(Collection collection) {
    ...
    private static class PermutationIterator<E> extends AbstractIterator<List<E>> {
        ...
        PermutationIterator(List<E> list) {
            ...
            int n = list.size();
            this.f155c = new int[n];
            this.f157o = new int[n];
            Arrays.fill(this.f155c, 0);
            Arrays.fill(this.f157o, 1);
        ...
        void calculateNextPermutation() {
            this.f156j = this.list.size() - 1;
            int s = 0;
            if (this.f156j != -1) {
                while (true) {
                    int q = this.f155c[this.f156j] + this.f157o[this.f156j];
                    if (q < 0) {
                        switchDirection();
                    } else if (q != this.f156j + 1) {
                        Collections.swap(this.list, (this.f156j - this.f155c[this.f156j]) + s, (this.f156j - q) + s);
                        this.f155c[this.f156j] = q;
                        return;
                    } else if (this.f156j != 0) {
                        s++;
                        switchDirection();
                    } else {
                        return;
        ...
        void switchDirection() {
            this.f157o[this.f156j] = -this.f157o[this.f156j];
            this.f156j--;
        }
    }
    ...
    static String toStringImpl(Collection<?> collection) {
        ...
        STANDARD_JOINER.appendTo(sb, Iterables.transform(collection, new C06611(collection)));
