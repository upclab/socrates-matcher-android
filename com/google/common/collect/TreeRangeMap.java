...
public final class TreeRangeMap<K extends Comparable, V> implements RangeMap<K, V> {
    ...
    private final class AsMapOfRanges extends AbstractMap<Range<K>, V> {
        ...
        class C02661 extends AbstractSet<Entry<Range<K>, V>> {
            C02661() {
            }
    ...
    static class C07571 implements RangeMap {
        C07571() {
        }
    ...
    private class SubRangeMap implements RangeMap<K, V> {
        ...
        class SubRangeMapAsMap extends AbstractMap<Range<K>, V> {
            ...
            class C07583 extends Values<Range<K>, V> {
                C07583(Map x0) {
                    super(x0);
                }
            ...
            class C10141 extends KeySet<Range<K>, V> {
                C10141(Map x0) {
                    super(x0);
                }
            ...
            class C10162 extends EntrySet<Range<K>, V> {

                /* renamed from: com.google.common.collect.TreeRangeMap.SubRangeMap.SubRangeMapAsMap.2.1 */
                class C10151 extends AbstractIterator<Entry<Range<K>, V>> {
                ...
                public Iterator<Entry<Range<K>, V>> iterator() {
                    ...
                    return new C10151(TreeRangeMap.this.entriesByLowerBound.tailMap((Cut) Objects.firstNonNull(TreeRangeMap.this.entriesByLowerBound.floorKey(SubRangeMap.this.subRange.lowerBound), SubRangeMap.this.subRange.lowerBound), true).values().iterator());
                }
    ...
    static {
        EMPTY_SUB_RANGE_MAP = new C07571();
    }
