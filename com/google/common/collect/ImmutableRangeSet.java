...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
    ...
    class C09671 extends ImmutableList<Range<C>> {
        final /* synthetic */ int val$fromIndex;
        final /* synthetic */ int val$length;
        final /* synthetic */ Range val$range;

        C09671(int i, int i2, Range range) {
            this.val$length = i;
    ...
    private final class AsSet extends ImmutableSortedSet<C> {
        ...
        class C09681 extends AbstractIterator<C> {
            Iterator<C> elemItr;
        ...
        class C09692 extends AbstractIterator<C> {
            Iterator<C> elemItr;
            final Iterator<Range<C>> rangeItr;
    ...
    private ImmutableList<Range<C>> intersectRanges(Range<C> range) {
        ...
        return new C09671(length, fromIndex, range);
    }
