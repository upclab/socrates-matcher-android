...
class FilteredEntryMultimap<K, V> extends AbstractMultimap<K, V> implements FilteredMultimap<K, V> {
    ...
    class AsMap extends ImprovedAbstractMap<K, Collection<V>> {
        ...
        class C06633 extends Values<K, Collection<V>> {
            C06633(Map x0) {
                super(x0);
            }
        ...
        class C09571 extends KeySet<K, Collection<V>> {
            C09571(Map x0) {
                super(x0);
            }
        ...
        class C09592 extends EntrySet<K, Collection<V>> {

            /* renamed from: com.google.common.collect.FilteredEntryMultimap.AsMap.2.1 */
            class C09581 extends AbstractIterator<Entry<K, Collection<V>>> {
    ...
    class Keys extends Keys<K, V> {
        ...
        class C09601 extends EntrySet<K> {

            /* renamed from: com.google.common.collect.FilteredEntryMultimap.Keys.1.1 */
            class C06641 implements Predicate<Entry<K, Collection<V>>> {
                final /* synthetic */ Predicate val$predicate;

                C06641(Predicate predicate) {
            ...
            private boolean removeEntriesIf(Predicate<? super Multiset.Entry<K>> predicate) {
                return FilteredEntryMultimap.this.removeEntriesIf(new C06641(predicate));
            }
