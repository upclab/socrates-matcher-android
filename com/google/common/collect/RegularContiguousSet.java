...
final class RegularContiguousSet<C extends Comparable> extends ContiguousSet<C> {
    ...
    class C10051 extends AbstractSequentialIterator<C> {
        final C last;

        C10051(Comparable x0) {
            super(x0);
    ...
    class C10062 extends AbstractSequentialIterator<C> {
        final C first;

        C10062(Comparable x0) {
            super(x0);
    ...
    public UnmodifiableIterator<C> iterator() {
        return new C10051(first());
    }

    @GwtIncompatible("NavigableSet")
    public UnmodifiableIterator<C> descendingIterator() {
        return new C10062(last());
    }
