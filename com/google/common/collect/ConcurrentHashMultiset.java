...
public final class ConcurrentHashMultiset<E> extends AbstractMultiset<E> implements Serializable {
    ...
    class C09532 extends AbstractIterator<Entry<E>> {
    ...
    class C09543 extends ForwardingIterator<Entry<E>> {
    ...
    class C10781 extends ForwardingSet<E> {
    ...
    Set<E> createElementSet() {
        return new C10781(this.countMap.keySet());
    }
