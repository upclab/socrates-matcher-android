...
public final class Multimaps {
    ...
    static final class AsMap<K, V> extends ImprovedAbstractMap<K, Collection<V>> {
        ...
        class EntrySet extends EntrySet<K, Collection<V>> {
            ...
            class C07211 implements Function<K, Collection<V>> {
                C07211() {
                }
            ...
            public Iterator<Entry<K, Collection<V>>> iterator() {
                return Maps.asMapEntryIterator(AsMap.this.multimap.keySet(), new C07211());
            }
    ...
    static class Keys<K, V> extends AbstractMultiset<K> {
        ...
        class C07221 extends TransformedIterator<Entry<K, Collection<V>>, Multiset.Entry<K>> {

            /* renamed from: com.google.common.collect.Multimaps.Keys.1.1 */
            class C09961 extends AbstractEntry<K> {
            ...
            Multiset.Entry<K> transform(Entry<K, Collection<V>> backingEntry) {
                return new C09961(backingEntry);
            }
        }
        ...
        Iterator<Multiset.Entry<K>> entryIterator() {
            return new C07221(this.multimap.asMap().entrySet().iterator());
        }
    ...
    private static class MapMultimap<K, V> extends AbstractMultimap<K, V> implements SetMultimap<K, V>, Serializable {
        ...
        class C07231 extends ImprovedAbstractSet<V> {
            final /* synthetic */ Object val$key;

            /* renamed from: com.google.common.collect.Multimaps.MapMultimap.1.1 */
            class C02521 implements Iterator<V> {
                int f47i;
                ...
                public boolean hasNext() {
                    return this.f47i == 0 && MapMultimap.this.map.containsKey(C07231.this.val$key);
                }

                public V next() {
                    if (hasNext()) {
                        this.f47i++;
                        return MapMultimap.this.map.get(C07231.this.val$key);
                    }
                ...
                public void remove() {
                    ...
                    this.f47i = -1;
                    MapMultimap.this.map.remove(C07231.this.val$key);
                }
            }
    ...
    private static class TransformedEntriesMultimap<K, V1, V2> extends AbstractMultimap<K, V2> {
        ...
        class C07241 implements EntryTransformer<K, Collection<V1>, Collection<V2>> {
            C07241() {
            }
        ...
        Map<K, Collection<V2>> createAsMap() {
            return Maps.transformEntries(this.fromMultimap.asMap(), new C07241());
        }
    ...
    private static class UnmodifiableMultimap<K, V> extends ForwardingMultimap<K, V> implements Serializable {
        ...
        class C07251 implements Function<Collection<V>, Collection<V>> {
            C07251() {
            }
        ...
        public Map<K, Collection<V>> asMap() {
            ...
            result = Collections.unmodifiableMap(Maps.transformValues(this.delegate.asMap(), new C07251()));
            this.map = result;
            return result;
        }
