...
public final class Multisets {
    ...
    static class C07265 extends Ordering<Entry<?>> {
        C07265() {
        }
    ...
    static abstract class ElementSet<E> extends ImprovedAbstractSet<E> {
        ...
        class C07271 extends TransformedIterator<Entry<E>, E> {
            C07271(Iterator x0) {
                super(x0);
            }
        ...
        public Iterator<E> iterator() {
            return new C07271(multiset().entrySet().iterator());
        }
    ...
    static class C09981 extends AbstractMultiset<E> {
        ...
        class C09971 extends AbstractIterator<Entry<E>> {
            final /* synthetic */ Iterator val$iterator1;
            final /* synthetic */ Iterator val$iterator2;

            C09971(Iterator it, Iterator it2) {
            ...
            protected Entry<E> computeNext() {
                if (this.val$iterator1.hasNext()) {
                    ...
                    return Multisets.immutableEntry(element, Math.max(entry1.getCount(), C09981.this.val$multiset2.count(element)));
                }
                while (this.val$iterator2.hasNext()) {
                    Entry<? extends E> entry2 = (Entry) this.val$iterator2.next();
                    element = entry2.getElement();
                    if (!C09981.this.val$multiset1.contains(element)) {
        ...
        C09981(Multiset multiset, Multiset multiset2) {
        ...
        Iterator<Entry<E>> entryIterator() {
            return new C09971(this.val$multiset1.entrySet().iterator(), this.val$multiset2.entrySet().iterator());
        }
    ...
    static class C10002 extends AbstractMultiset<E> {
        final /* synthetic */ Multiset val$multiset1;
        final /* synthetic */ Multiset val$multiset2;

        /* renamed from: com.google.common.collect.Multisets.2.1 */
        class C09991 extends AbstractIterator<Entry<E>> {
            final /* synthetic */ Iterator val$iterator1;
            ...
            protected Entry<E> computeNext() {
                while (this.val$iterator1.hasNext()) {
                    ...
                    E element = entry1.getElement();
                    int count = Math.min(entry1.getCount(), C10002.this.val$multiset2.count(element));
                    if (count > 0) {
        ...
        C10002(Multiset multiset, Multiset multiset2) {
            this.val$multiset1 = multiset;
            this.val$multiset2 = multiset2;
        }
        ...
        Iterator<Entry<E>> entryIterator() {
            return new C09991(this.val$multiset1.entrySet().iterator());
        }
    ...
    static class C10023 extends AbstractMultiset<E> {
        final /* synthetic */ Multiset val$multiset1;
        final /* synthetic */ Multiset val$multiset2;

        /* renamed from: com.google.common.collect.Multisets.3.1 */
        class C10011 extends AbstractIterator<Entry<E>> {
            final /* synthetic */ Iterator val$iterator1;
            final /* synthetic */ Iterator val$iterator2;

            C10011(Iterator it, Iterator it2) {
                this.val$iterator1 = it;
                this.val$iterator2 = it2;
            }
            ...
            protected Entry<E> computeNext() {
                if (this.val$iterator1.hasNext()) {
                    Entry<? extends E> entry1 = (Entry) this.val$iterator1.next();
                    E element = entry1.getElement();
                    return Multisets.immutableEntry(element, entry1.getCount() + C10023.this.val$multiset2.count(element));
                }
                while (this.val$iterator2.hasNext()) {
                    Entry<? extends E> entry2 = (Entry) this.val$iterator2.next();
                    element = entry2.getElement();
                    if (!C10023.this.val$multiset1.contains(element)) {
                        return Multisets.immutableEntry(element, entry2.getCount());
                    }
                }
                return (Entry) endOfData();
        ...
        C10023(Multiset multiset, Multiset multiset2) {
            this.val$multiset1 = multiset;
            this.val$multiset2 = multiset2;
        }
        ...
        Iterator<Entry<E>> entryIterator() {
            return new C10011(this.val$multiset1.entrySet().iterator(), this.val$multiset2.entrySet().iterator());
        }
    ...
    static class C10044 extends AbstractMultiset<E> {
        final /* synthetic */ Multiset val$multiset1;
        final /* synthetic */ Multiset val$multiset2;

        /* renamed from: com.google.common.collect.Multisets.4.1 */
        class C10031 extends AbstractIterator<Entry<E>> {
            final /* synthetic */ Iterator val$iterator1;
            ...
            protected Entry<E> computeNext() {
                while (this.val$iterator1.hasNext()) {
                    Entry<E> entry1 = (Entry) this.val$iterator1.next();
                    E element = entry1.getElement();
                    int count = entry1.getCount() - C10044.this.val$multiset2.count(element);
                    if (count > 0) {
                        return Multisets.immutableEntry(element, count);
                    }
                }
        ...
        C10044(Multiset multiset, Multiset multiset2) {
            this.val$multiset1 = multiset;
            this.val$multiset2 = multiset2;
        }
        ...
        Iterator<Entry<E>> entryIterator() {
            return new C10031(this.val$multiset1.entrySet().iterator());
        }
    ...
    private static final class FilteredMultiset<E> extends AbstractMultiset<E> {
        ...
        class C07281 implements Predicate<Entry<E>> {
            C07281() {
            }
        ...
        Set<Entry<E>> createEntrySet() {
            return Sets.filter(this.unfiltered.entrySet(), new C07281());
        }
    ...
    public static <E> Multiset<E> sum(Multiset<? extends E> multiset1, Multiset<? extends E> multiset2) {
        Preconditions.checkNotNull(multiset1);
        Preconditions.checkNotNull(multiset2);
        return new C10023(multiset1, multiset2);
    }
    ...
    public static <E> Multiset<E> difference(Multiset<E> multiset1, Multiset<?> multiset2) {
        Preconditions.checkNotNull(multiset1);
        Preconditions.checkNotNull(multiset2);
        return new C10044(multiset1, multiset2);
    }
    ...
    static {
        DECREASING_COUNT_ORDERING = new C07265();
    }
