...
public abstract class BinaryTreeTraverser<T> extends TreeTraverser<T> {
    ...
    /* renamed from: com.google.common.collect.BinaryTreeTraverser.1 */
    class C06571 extends FluentIterable<T> {
        final /* synthetic */ Object val$root;

        /* renamed from: com.google.common.collect.BinaryTreeTraverser.1.1 */
        class C09511 extends AbstractIterator<T> {
            boolean doneLeft;
            boolean doneRight;
            ...
            protected T computeNext() {
                if (!this.doneLeft) {
                    this.doneLeft = true;
                    Optional<T> left = BinaryTreeTraverser.this.leftChild(C06571.this.val$root);
                    if (left.isPresent()) {
                        return left.get();
                    }
                }
                if (!this.doneRight) {
                    this.doneRight = true;
                    Optional<T> right = BinaryTreeTraverser.this.rightChild(C06571.this.val$root);
                    if (right.isPresent()) {
                        return right.get();
                    }
                }
    ...
    /* renamed from: com.google.common.collect.BinaryTreeTraverser.2 */
    class C06582 extends FluentIterable<T> {
        final /* synthetic */ Object val$root;
