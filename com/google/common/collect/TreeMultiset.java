...
public final class TreeMultiset<E> extends AbstractSortedMultiset<E> implements Serializable {
    ...
    class C02632 implements Iterator<Entry<E>> {
        AvlNode<E> current;
        Entry<E> prevEntry;
    ...
    class C02643 implements Iterator<Entry<E>> {
        AvlNode<E> current;
        Entry<E> prevEntry;
    ...
    class C10131 extends AbstractEntry<E> {
        final /* synthetic */ AvlNode val$baseEntry;

        C10131(AvlNode avlNode) {
    ...
    private long aggregateBelowRange(Aggregate aggr, @Nullable AvlNode<E> node) {
        ...
        switch (C02654.$SwitchMap$com$google$common$collect$BoundType[this.range.getLowerBoundType().ordinal()]) {
    ...
    private long aggregateAboveRange(Aggregate aggr, @Nullable AvlNode<E> node) {
        ...
        switch (C02654.$SwitchMap$com$google$common$collect$BoundType[this.range.getUpperBoundType().ordinal()]) {
            case Value.TYPE_FIELD_NUMBER /*1*/:
