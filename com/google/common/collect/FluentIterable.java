...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    static class C06651 extends FluentIterable<E> {
        final /* synthetic */ Iterable val$iterable;

        C06651(Iterable x0, Iterable iterable) {
    ...
    public static <E> FluentIterable<E> from(Iterable<E> iterable) {
        return iterable instanceof FluentIterable ? (FluentIterable) iterable : new C06651(iterable, iterable);
    }
