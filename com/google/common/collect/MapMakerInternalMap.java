...
class MapMakerInternalMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable {
    ...
    static class C02502 extends AbstractQueue<Object> {
        C02502() {
        }
    ...
    static final class EvictionQueue<K, V> extends AbstractQueue<ReferenceEntry<K, V>> {
        ...
        class C09811 extends AbstractReferenceEntry<K, V> {
        ...
        class C09822 extends AbstractSequentialIterator<ReferenceEntry<K, V>> {
            C09822(ReferenceEntry x0) {
                super(x0);
            }
    ...
    static final class ExpirationQueue<K, V> extends AbstractQueue<ReferenceEntry<K, V>> {
        ...
        class C09831 extends AbstractReferenceEntry<K, V> {
        ...
        class C09842 extends AbstractSequentialIterator<ReferenceEntry<K, V>> {
            C09842(ReferenceEntry x0) {
                super(x0);
            }
    ...
    static class C06961 implements ValueReference<Object, Object> {
        C06961() {
        }
