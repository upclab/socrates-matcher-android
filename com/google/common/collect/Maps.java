...
public final class Maps {
    ...
    static class AnonymousClass10 extends AbstractMapEntry<K, V2> {
        final /* synthetic */ Entry val$entry;
        final /* synthetic */ EntryTransformer val$transformer;

        AnonymousClass10(Entry entry, EntryTransformer entryTransformer) {
    ...
    static class AnonymousClass11 implements Function<Entry<K, V1>, Entry<K, V2>> {
        final /* synthetic */ EntryTransformer val$transformer;
    ...
    static class C07081 extends UnmodifiableIterator<V> {
        final /* synthetic */ UnmodifiableIterator val$entryIterator;

        C07081(UnmodifiableIterator unmodifiableIterator) {
    ...
    static class C07092 extends TransformedIterator<K, Entry<K, V>> {
        final /* synthetic */ Function val$function;

        C07092(Iterator x0, Function function) {
    ...
    static class C07106 extends AbstractMapEntry<K, V> {
        final /* synthetic */ Entry val$entry;
    ...
    static class C07117 implements EntryTransformer<K, V1, V2> {
        final /* synthetic */ Function val$function;

        C07117(Function function) {
            this.val$function = function;
        }
    ...
    static class C07128 implements Function<V1, V2> {
        final /* synthetic */ Object val$key;
        final /* synthetic */ EntryTransformer val$transformer;

        C07128(EntryTransformer entryTransformer, Object obj) {
            this.val$transformer = entryTransformer;
            this.val$key = obj;
        }
    ...
    static class C07139 implements Function<Entry<K, V1>, V2> {
        final /* synthetic */ EntryTransformer val$transformer;

        C07139(EntryTransformer entryTransformer) {
            this.val$transformer = entryTransformer;
        }
    ...
    private static class AsMapView<K, V> extends ImprovedAbstractMap<K, V> {
        ...
        class C09851 extends EntrySet<K, V> {
            C09851() {
            }
    ...
    private static class FilteredEntryNavigableMap<K, V> extends AbstractNavigableMap<K, V> {
        ...
        class C11011 extends NavigableKeySet<K, V> {
            C11011(NavigableMap x0) {
                super(x0);
            }
    ...
    static class TransformedEntriesMap<K, V1, V2> extends ImprovedAbstractMap<K, V2> {
        ...
        class C09901 extends EntrySet<K, V2> {
            C09901() {
            }
    ...
    static abstract class DescendingMap<K, V> extends ForwardingMap<K, V> implements NavigableMap<K, V> {
        ...
        class C09861 extends EntrySet<K, V> {
            C09861() {
            }
    ...
    static class FilteredEntryMap<K, V> extends AbstractFilteredMap<K, V> {
        ...
        private class EntrySet extends ForwardingSet<Entry<K, V>> {
            ...
            class C07151 extends TransformedIterator<Entry<K, V>, Entry<K, V>> {

                /* renamed from: com.google.common.collect.Maps.FilteredEntryMap.EntrySet.1.1 */
                class C09891 extends ForwardingMapEntry<K, V> {
                    final /* synthetic */ Entry val$entry;
            ...
            public Iterator<Entry<K, V>> iterator() {
                return new C07151(FilteredEntryMap.this.filteredEntrySet.iterator());
            }
        }
    ...
    static class UnmodifiableEntries<K, V> extends ForwardingCollection<Entry<K, V>> {
        ...
        class C07161 extends UnmodifiableIterator<Entry<K, V>> {
        ...
        public Iterator<Entry<K, V>> iterator() {
            return new C07161(super.iterator());
        }
    ...
    static class C10863 extends ForwardingSet<E> {
    ...
    static final class FilteredEntryBiMap<K, V> extends FilteredEntryMap<K, V> implements BiMap<K, V> {
        ...
        static class C07141 implements Predicate<Entry<V, K>> {
            final /* synthetic */ Predicate val$forwardPredicate;

            C07141(Predicate predicate) {
        ...
        private static <K, V> Predicate<Entry<V, K>> inversePredicate(Predicate<? super Entry<K, V>> forwardPredicate) {
            return new C07141(forwardPredicate);
        }
    ...
    static class C11004 extends ForwardingSortedSet<E> {
        final /* synthetic */ SortedSet val$set;

        C11004(SortedSet sortedSet) {
    ...
    static class C11025 extends ForwardingNavigableSet<E> {
        final /* synthetic */ NavigableSet val$set;

        C11025(NavigableSet navigableSet) {
    ...
    static <K, V> UnmodifiableIterator<V> valueIterator(UnmodifiableIterator<Entry<K, V>> entryIterator) {
        return new C07081(entryIterator);
    }
