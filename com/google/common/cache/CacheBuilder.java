...
public final class CacheBuilder<K, V> {
    ...
    static class C06281 implements StatsCounter {
        C06281() {
        }
    ...
    static class C06292 implements Supplier<StatsCounter> {
        C06292() {
        }
    ...
    static class C06303 extends Ticker {
        C06303() {
        }
    ...
    static {
        NULL_STATS_COUNTER = Suppliers.ofInstance(new C06281());
        EMPTY_STATS = new CacheStats(0, 0, 0, 0, 0, 0);
        CACHE_STATS_COUNTER = new C06292();
        NULL_TICKER = new C06303();
