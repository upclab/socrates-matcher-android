...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    static class C02192 extends AbstractQueue<Object> {
        C02192() {
        }
    ...
    static final class AccessQueue<K, V> extends AbstractQueue<ReferenceEntry<K, V>> {
        ...
        class C09421 extends AbstractReferenceEntry<K, V> {
        ...
        class C09432 extends AbstractSequentialIterator<ReferenceEntry<K, V>> {
            C09432(ReferenceEntry x0) {
                super(x0);
            }
    ...
    static class Segment<K, V> extends ReentrantLock {
        ...
        class C02201 implements Runnable {
            ...
            C02201(Object obj, int i, LoadingValueReference loadingValueReference, ListenableFuture listenableFuture) {
                this.val$key = obj;
                this.val$hash = i;
            ...
            public void run() {
                try {
                    Segment.this.getAndRecordStats(this.val$key, this.val$hash, this.val$loadingValueReference, this.val$loadingFuture);
                } catch (Throwable t) {
        ...
        ListenableFuture<V> loadAsync(K key, int hash, LoadingValueReference<K, V> loadingValueReference, CacheLoader<? super K, V> loader) {
            ...
            loadingFuture.addListener(new C02201(key, hash, loadingValueReference, loadingFuture), LocalCache.sameThreadExecutor);
    ...
    static final class WriteQueue<K, V> extends AbstractQueue<ReferenceEntry<K, V>> {
        ...
        class C09441 extends AbstractReferenceEntry<K, V> {
        ...
        class C09452 extends AbstractSequentialIterator<ReferenceEntry<K, V>> {
            C09452(ReferenceEntry x0) {
                super(x0);
            }
    ...
    static class C06311 implements ValueReference<Object, Object> {
        C06311() {
        }
    ...
    static class LoadingValueReference<K, V> implements ValueReference<K, V> {
        ...
        class C06401 implements Function<V, V> {
            C06401() {
            }
        ...
        public ListenableFuture<V> loadFuture(K key, CacheLoader<? super K, V> loader) {
            ...
            if (previousValue == null) {
                ...
                return Futures.transform(newValue2, new C06401());
            }
        }
    ...
    static class LocalManualCache<K, V> implements Cache<K, V>, Serializable {
        ...
        class C06411 extends CacheLoader<Object, V> {
            final /* synthetic */ Callable val$valueLoader;

            C06411(Callable callable) {
        ...
        public V get(K key, Callable<? extends V> valueLoader) throws ExecutionException {
            ...
            return this.localCache.get(key, new C06411(valueLoader));
        }
