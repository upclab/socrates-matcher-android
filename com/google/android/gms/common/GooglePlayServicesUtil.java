...
public final class GooglePlayServicesUtil {
    ...
    public static Intent m15a(Context context, int i, int i2) {
        switch (i) {
            case Value.TYPE_FIELD_NUMBER /*1*/:
            case Value.STRING_FIELD_NUMBER /*2*/:
                return m21b(i2) ? m24c(context) ? C0151m.m486l(GOOGLE_PLAY_SERVICES_PACKAGE) : C0151m.m485k("com.google.android.apps.bazaar") : C0151m.m485k(GOOGLE_PLAY_SERVICES_PACKAGE);
            case Value.LIST_ITEM_FIELD_NUMBER /*3*/:
    ...
    public static String m20b(Context context, int i, int i2) {
        ...
        switch (i) {
            case Value.TYPE_FIELD_NUMBER /*1*/:
                string = m17a(context.getResources()) ? resources.getString(C0092R.string.common_google_play_services_install_text_tablet) : resources.getString(C0092R.string.common_google_play_services_install_text_phone);
    ...
    private static boolean m24c(Context context) {
        ...
        try {
            return m18a(context.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", 64), f18I) != null;
