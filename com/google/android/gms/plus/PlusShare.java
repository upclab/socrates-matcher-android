...
public final class PlusShare {
    ...
    public static class Builder {
        ...
        public Builder(Activity launchingActivity, PlusClient plusClient) {
            ...
            C0159s.m512a(plusClient != null, "Must include the PlusClient object in PlusShare.Builder constructor to create an interactive post.");
            C0159s.m512a(plusClient.isConnected(), "PlusClient must be connected to create an interactive post.");
            C0159s.m512a(plusClient.bu().m1280F(Scopes.PLUS_LOGIN), "Must request PLUS_LOGIN scope in PlusClient to create an interactive post.");
        ...
        public Builder addCallToAction(String label, Uri uri, String deepLinkId) {
            C0159s.m512a(this.im, "Must include the launching activity with PlusShare.Builder constructor before setting call-to-action");
            boolean z = (uri == null || TextUtils.isEmpty(uri.toString())) ? false : true;
            C0159s.m515b(z, (Object) "Must provide a call to action URL");
            C0159s.m512a(this.io, "Must include PlusClient in PlusShare.Builder constructor to create an interactive post");
            ...
            if (!TextUtils.isEmpty(deepLinkId)) {
                C0159s.m512a(PlusShare.isDeepLinkIdValid(deepLinkId), "The specified deep-link ID was malformed.");
        ...
        public Intent getIntent() {
            ...
            C0159s.m512a(z3, "Call-to-action buttons are only available for URLs.");
            z3 = !booleanExtra || this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_URL);
            C0159s.m512a(z3, "The content URL is required for interactive posts.");
            ...
            C0159s.m512a(z, "Must set content URL or content deep-link ID to use a call-to-action button.");
            if (this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)) {
                C0159s.m512a(PlusShare.isDeepLinkIdValid(this.mIntent.getStringExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)), "The specified deep-link ID was malformed.");
            }
            if (!z2 && equals) {
        ...
        public Builder setContentDeepLinkId(String deepLinkId, String title, String description, Uri thumbnailUri) {
            C0159s.m515b(this.im, (Object) "Must include the launching activity with PlusShare.Builder constructor before setting deep links");
            C0159s.m515b(!TextUtils.isEmpty(deepLinkId), (Object) "The deepLinkId parameter is required.");
            Bundle a = PlusShare.m600a(title, description, thumbnailUri);
    ...
    public static Bundle m600a(String str, String str2, Uri uri) {
        Bundle bundle = new Bundle();
