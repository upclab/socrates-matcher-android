...
public class by implements Creator<bx> {
    static void m411a(bx bxVar, Parcel parcel, int i) {
        int d = C0109b.m127d(parcel);
        Set bH = bxVar.bH();
        if (bH.contains(Integer.valueOf(1))) {
            C0109b.m125c(parcel, 1, bxVar.m1291i());
        }
        if (bH.contains(Integer.valueOf(2))) {
            C0109b.m114a(parcel, 2, bxVar.bI(), i, true);
        }
        if (bH.contains(Integer.valueOf(3))) {
            C0109b.m116a(parcel, 3, bxVar.getAdditionalName(), true);
        }
        if (bH.contains(Integer.valueOf(4))) {
            C0109b.m114a(parcel, 4, bxVar.bJ(), i, true);
        }
        if (bH.contains(Integer.valueOf(5))) {
            C0109b.m115a(parcel, 5, bxVar.getAddressCountry(), true);
        }
        if (bH.contains(Integer.valueOf(6))) {
            C0109b.m115a(parcel, 6, bxVar.getAddressLocality(), true);
        }
        if (bH.contains(Integer.valueOf(7))) {
            C0109b.m115a(parcel, 7, bxVar.getAddressRegion(), true);
        }
        if (bH.contains(Integer.valueOf(8))) {
            C0109b.m124b(parcel, 8, bxVar.bK(), true);
        }
        if (bH.contains(Integer.valueOf(9))) {
            C0109b.m125c(parcel, 9, bxVar.getAttendeeCount());
        }
        if (bH.contains(Integer.valueOf(10))) {
            C0109b.m124b(parcel, 10, bxVar.bL(), true);
        }
        if (bH.contains(Integer.valueOf(11))) {
            C0109b.m114a(parcel, 11, bxVar.bM(), i, true);
        }
        if (bH.contains(Integer.valueOf(12))) {
            C0109b.m124b(parcel, 12, bxVar.bN(), true);
        }
        if (bH.contains(Integer.valueOf(13))) {
            C0109b.m115a(parcel, 13, bxVar.getBestRating(), true);
        }
        if (bH.contains(Integer.valueOf(14))) {
            C0109b.m115a(parcel, 14, bxVar.getBirthDate(), true);
        }
        if (bH.contains(Integer.valueOf(15))) {
            C0109b.m114a(parcel, 15, bxVar.bO(), i, true);
        }
        if (bH.contains(Integer.valueOf(17))) {
            C0109b.m115a(parcel, 17, bxVar.getContentSize(), true);
        }
        if (bH.contains(Integer.valueOf(16))) {
            C0109b.m115a(parcel, 16, bxVar.getCaption(), true);
        }
        if (bH.contains(Integer.valueOf(19))) {
            C0109b.m124b(parcel, 19, bxVar.bP(), true);
        }
        if (bH.contains(Integer.valueOf(18))) {
            C0109b.m115a(parcel, 18, bxVar.getContentUrl(), true);
        }
        if (bH.contains(Integer.valueOf(21))) {
            C0109b.m115a(parcel, 21, bxVar.getDateModified(), true);
        }
        if (bH.contains(Integer.valueOf(20))) {
            C0109b.m115a(parcel, 20, bxVar.getDateCreated(), true);
        }
        if (bH.contains(Integer.valueOf(23))) {
            C0109b.m115a(parcel, 23, bxVar.getDescription(), true);
        }
        if (bH.contains(Integer.valueOf(22))) {
            C0109b.m115a(parcel, 22, bxVar.getDatePublished(), true);
        }
        if (bH.contains(Integer.valueOf(25))) {
            C0109b.m115a(parcel, 25, bxVar.getEmbedUrl(), true);
        }
        if (bH.contains(Integer.valueOf(24))) {
            C0109b.m115a(parcel, 24, bxVar.getDuration(), true);
        }
        if (bH.contains(Integer.valueOf(27))) {
            C0109b.m115a(parcel, 27, bxVar.getFamilyName(), true);
        }
        if (bH.contains(Integer.valueOf(26))) {
            C0109b.m115a(parcel, 26, bxVar.getEndDate(), true);
        }
        if (bH.contains(Integer.valueOf(29))) {
            C0109b.m114a(parcel, 29, bxVar.bQ(), i, true);
        }
        if (bH.contains(Integer.valueOf(28))) {
            C0109b.m115a(parcel, 28, bxVar.getGender(), true);
        }
        if (bH.contains(Integer.valueOf(31))) {
            C0109b.m115a(parcel, 31, bxVar.getHeight(), true);
        }
        if (bH.contains(Integer.valueOf(30))) {
            C0109b.m115a(parcel, 30, bxVar.getGivenName(), true);
        }
        if (bH.contains(Integer.valueOf(34))) {
            C0109b.m114a(parcel, 34, bxVar.bR(), i, true);
        }
        if (bH.contains(Integer.valueOf(32))) {
            C0109b.m115a(parcel, 32, bxVar.getId(), true);
        }
        if (bH.contains(Integer.valueOf(33))) {
            C0109b.m115a(parcel, 33, bxVar.getImage(), true);
        }
        if (bH.contains(Integer.valueOf(38))) {
            C0109b.m108a(parcel, 38, bxVar.getLongitude());
        }
        if (bH.contains(Integer.valueOf(39))) {
            C0109b.m115a(parcel, 39, bxVar.getName(), true);
        }
        if (bH.contains(Integer.valueOf(36))) {
            C0109b.m108a(parcel, 36, bxVar.getLatitude());
        }
        if (bH.contains(Integer.valueOf(37))) {
            C0109b.m114a(parcel, 37, bxVar.bS(), i, true);
        }
        if (bH.contains(Integer.valueOf(42))) {
            C0109b.m115a(parcel, 42, bxVar.getPlayerType(), true);
        }
        if (bH.contains(Integer.valueOf(43))) {
            C0109b.m115a(parcel, 43, bxVar.getPostOfficeBoxNumber(), true);
        }
        if (bH.contains(Integer.valueOf(40))) {
            C0109b.m114a(parcel, 40, bxVar.bT(), i, true);
        }
        if (bH.contains(Integer.valueOf(41))) {
            C0109b.m124b(parcel, 41, bxVar.bU(), true);
        }
        if (bH.contains(Integer.valueOf(46))) {
            C0109b.m114a(parcel, 46, bxVar.bV(), i, true);
        }
        if (bH.contains(Integer.valueOf(47))) {
            C0109b.m115a(parcel, 47, bxVar.getStartDate(), true);
        }
        if (bH.contains(Integer.valueOf(44))) {
            C0109b.m115a(parcel, 44, bxVar.getPostalCode(), true);
        }
        if (bH.contains(Integer.valueOf(45))) {
            C0109b.m115a(parcel, 45, bxVar.getRatingValue(), true);
        }
        if (bH.contains(Integer.valueOf(51))) {
            C0109b.m115a(parcel, 51, bxVar.getThumbnailUrl(), true);
        }
        if (bH.contains(Integer.valueOf(50))) {
            C0109b.m114a(parcel, 50, bxVar.bW(), i, true);
        }
        if (bH.contains(Integer.valueOf(49))) {
            C0109b.m115a(parcel, 49, bxVar.getText(), true);
        }
        if (bH.contains(Integer.valueOf(48))) {
            C0109b.m115a(parcel, 48, bxVar.getStreetAddress(), true);
        }
        if (bH.contains(Integer.valueOf(55))) {
            C0109b.m115a(parcel, 55, bxVar.getWidth(), true);
        }
        if (bH.contains(Integer.valueOf(54))) {
            C0109b.m115a(parcel, 54, bxVar.getUrl(), true);
        }
        if (bH.contains(Integer.valueOf(53))) {
            C0109b.m115a(parcel, 53, bxVar.getType(), true);
        }
        if (bH.contains(Integer.valueOf(52))) {
            C0109b.m115a(parcel, 52, bxVar.getTickerSymbol(), true);
        }
        if (bH.contains(Integer.valueOf(56))) {
            C0109b.m115a(parcel, 56, bxVar.getWorstRating(), true);
        }
        C0109b.m106C(parcel, d);
    }

    public bx[] m412W(int i) {
        return new bx[i];
    }
        ...
        while (parcel.dataPosition() < c) {
            ...
            switch (C0108a.m89m(b)) {
                ...
                case Value.STRING_FIELD_NUMBER /*2*/:
                    bxVar11 = (bx) C0108a.m71a(parcel, b, bx.CREATOR);
                    hashSet.add(Integer.valueOf(2));
                    bxVar = bxVar11;
                    break;
                case Value.LIST_ITEM_FIELD_NUMBER /*3*/:
                    list = C0108a.m101x(parcel, b);
                ...
                case Value.INTEGER_FIELD_NUMBER /*8*/:
                    list2 = C0108a.m78c(parcel, b, bx.CREATOR);
                ...
                case Value.ESCAPING_FIELD_NUMBER /*10*/:
                    list3 = C0108a.m78c(parcel, b, bx.CREATOR);
                ...
                case Value.BOOLEAN_FIELD_NUMBER /*12*/:
                    list4 = C0108a.m78c(parcel, b, bx.CREATOR);
                ...
                case TimeUtils.HUNDRED_DAY_FIELD_LEN /*19*/:
                    list5 = C0108a.m78c(parcel, b, bx.CREATOR);
                ...
                case 21:
                    ...
                    break;
                case 22:
                    str11 = C0108a.m88l(parcel, b);
                    hashSet.add(Integer.valueOf(22));
                    break;
                case 23:
                    str12 = C0108a.m88l(parcel, b);
                    hashSet.add(Integer.valueOf(23));
                    break;
                case DateTimeConstants.HOURS_PER_DAY /*24*/:
                    str13 = C0108a.m88l(parcel, b);
                    hashSet.add(Integer.valueOf(24));
                    break;
                case 25:
                    str14 = C0108a.m88l(parcel, b);
                    hashSet.add(Integer.valueOf(25));
                    break;
                case 26:
                    str15 = C0108a.m88l(parcel, b);
                    hashSet.add(Integer.valueOf(26));
                    break;
                case 27:
                    str16 = C0108a.m88l(parcel, b);
                    hashSet.add(Integer.valueOf(27));
                    break;
                case 28:
                    str17 = C0108a.m88l(parcel, b);
                ...
                case Const.TOUCH_DISTANCE /*30*/:
                    str18 = C0108a.m88l(parcel, b);
                    hashSet.add(Integer.valueOf(30));
                    break;
                case 31:
                    str19 = C0108a.m88l(parcel, b);
                    hashSet.add(Integer.valueOf(31));
                    break;
                case Base64.ORDERED /*32*/:
                    str20 = C0108a.m88l(parcel, b);
                    hashSet.add(Integer.valueOf(32));
                    break;
                case 33:
                    str21 = C0108a.m88l(parcel, b);
                ...
                case 40:
                    ...
                    break;
                case 41:
                    list6 = C0108a.m78c(parcel, b, bx.CREATOR);
                    hashSet.add(Integer.valueOf(41));
                    break;
                case 42:
                    str23 = C0108a.m88l(parcel, b);
                    hashSet.add(Integer.valueOf(42));
                    break;
                case 43:
                    str24 = C0108a.m88l(parcel, b);
                    hashSet.add(Integer.valueOf(43));
                    break;
                case 44:
                    str25 = C0108a.m88l(parcel, b);
                    hashSet.add(Integer.valueOf(44));
                    break;
                case 45:
                    str26 = C0108a.m88l(parcel, b);
                ...
                case 46:
                    ...
                    break;
                case 47:
                    str27 = C0108a.m88l(parcel, b);
                    hashSet.add(Integer.valueOf(47));
                    break;
                case 48:
                    str28 = C0108a.m88l(parcel, b);
                    hashSet.add(Integer.valueOf(48));
                    break;
                case 49:
                    str29 = C0108a.m88l(parcel, b);
                ...
                case 50:
                    ...
                    break;
                case 51:
                    str30 = C0108a.m88l(parcel, b);
                    hashSet.add(Integer.valueOf(51));
                    break;
                case 52:
                    str31 = C0108a.m88l(parcel, b);
                    hashSet.add(Integer.valueOf(52));
                    break;
                case 53:
                    str32 = C0108a.m88l(parcel, b);
                    hashSet.add(Integer.valueOf(53));
                    break;
                case 54:
                    str33 = C0108a.m88l(parcel, b);
                    hashSet.add(Integer.valueOf(54));
                    break;
                case 55:
                    str34 = C0108a.m88l(parcel, b);
                    hashSet.add(Integer.valueOf(55));
                    break;
                case 56:
                    str35 = C0108a.m88l(parcel, b);
