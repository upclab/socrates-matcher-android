...
import com.google.android.gms.internal.cc.C0134e;
...
public final class cn extends C0097b implements Person {
    public cn(C0468d c0468d, int i) {
        super(c0468d, i);
    }

    public Person cA() {
        return new cc(getDisplayName(), getId(), (C0911c) getImage(), getObjectType(), getUrl());
    }
    ...
    public Image getImage() {
        return new C0911c(getString("image"));
    }
    ...
    public int getObjectType() {
        return C0134e.m417G(getString("objectType"));
    }
