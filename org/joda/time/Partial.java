...
public final class Partial extends AbstractPartial implements ReadablePartial, Serializable {
    ...
    public Partial(DateTimeFieldType[] dateTimeFieldTypeArr, int[] iArr, Chronology chronology) {
        ...
        if (dateTimeFieldTypeArr == null) {
            ...
            int i2;
            for (i2 = 0; i2 < dateTimeFieldTypeArr.length; i2++) {
            ...
            while (i < dateTimeFieldTypeArr.length) {
                ...
                if (i > 0) {
                    i2 = durationField.compareTo(field);
                    if (i2 < 0 || !(i2 == 0 || field.isSupported())) {
                        ...
                        durationField = dateTimeFieldTypeArr[i - 1].getRangeDurationType().getField(this.iChronology);
                        DurationField field2 = dateTimeFieldType.getRangeDurationType().getField(this.iChronology);
