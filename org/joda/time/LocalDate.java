...
public final class LocalDate extends BaseLocal implements ReadablePartial, Serializable {
    ...
    public static LocalDate fromCalendarFields(Calendar calendar) {
        ...
        return new LocalDate(i2, calendar.get(DAY_OF_MONTH) + MONTH_OF_YEAR, calendar.get(5));
    }
    ...
    public static LocalDate fromDateFields(Date date) {
        if (date == null) {
            ...
            return new LocalDate(date.getYear() + 1900, date.getMonth() + MONTH_OF_YEAR, date.getDate());
        } else {
    ...
    public LocalDate(Object obj, DateTimeZone dateTimeZone) {
        ...
        this.iLocalMillis = this.iChronology.getDateTimeMillis(partialValues[YEAR], partialValues[MONTH_OF_YEAR], partialValues[DAY_OF_MONTH], YEAR);
    }
    ...
    public LocalDate(int i, int i2, int i3, Chronology chronology) {
        ...
        long dateTimeMillis = withUTC.getDateTimeMillis(i, i2, i3, YEAR);
    ...
    public int compareTo(ReadablePartial readablePartial) {
        ...
        if (readablePartial instanceof LocalDate) {
            ...
            if (this.iChronology.equals(localDate.iChronology)) {
                int i = this.iLocalMillis < localDate.iLocalMillis ? -1 : this.iLocalMillis == localDate.iLocalMillis ? YEAR : MONTH_OF_YEAR;
                return i;
            }
        }
    ...
    public DateTime toDateTimeAtMidnight(DateTimeZone dateTimeZone) {
        return new DateTime(getYear(), getMonthOfYear(), getDayOfMonth(), (int) YEAR, YEAR, YEAR, YEAR, getChronology().withZone(DateTimeUtils.getZone(dateTimeZone)));
    }
    ...
    public Interval toInterval(DateTimeZone dateTimeZone) {
        DateTimeZone zone = DateTimeUtils.getZone(dateTimeZone);
        return new Interval(toDateTimeAtStartOfDay(zone), plusDays(MONTH_OF_YEAR).toDateTimeAtStartOfDay(zone));
    }
