...
public final class LocalDateTime extends BaseLocal implements ReadablePartial, Serializable {
    ...
    public static LocalDateTime fromCalendarFields(Calendar calendar) {
        ...
        int i = calendar.get(YEAR);
        int i2 = calendar.get(MONTH_OF_YEAR);
        if (i != MONTH_OF_YEAR) {
            i2 = 1 - i2;
        }
        return new LocalDateTime(i2, calendar.get(DAY_OF_MONTH) + MONTH_OF_YEAR, calendar.get(5), calendar.get(11), calendar.get(12), calendar.get(13), calendar.get(14));
    }
    ...
    public static LocalDateTime fromDateFields(Date date) {
        if (date == null) {
            ...
            return new LocalDateTime(date.getYear() + 1900, date.getMonth() + MONTH_OF_YEAR, date.getDate(), date.getHours(), date.getMinutes(), date.getSeconds(), (((int) (date.getTime() % 1000)) + DateTimeConstants.MILLIS_PER_SECOND) % DateTimeConstants.MILLIS_PER_SECOND);
        } else {
    ...
    public LocalDateTime(Object obj, DateTimeZone dateTimeZone) {
        ...
        this.iLocalMillis = this.iChronology.getDateTimeMillis(partialValues[YEAR], partialValues[MONTH_OF_YEAR], partialValues[DAY_OF_MONTH], partialValues[MILLIS_OF_DAY]);
    }
    ...
    public LocalDateTime(int i, int i2, int i3, int i4, int i5) {
        this(i, i2, i3, i4, i5, YEAR, YEAR, ISOChronology.getInstanceUTC());
    }

    public LocalDateTime(int i, int i2, int i3, int i4, int i5, int i6) {
        this(i, i2, i3, i4, i5, i6, YEAR, ISOChronology.getInstanceUTC());
    }
    ...
    public int compareTo(ReadablePartial readablePartial) {
        ...
        if (readablePartial instanceof LocalDateTime) {
            ...
            if (this.iChronology.equals(localDateTime.iChronology)) {
                int i = this.iLocalMillis < localDateTime.iLocalMillis ? -1 : this.iLocalMillis == localDateTime.iLocalMillis ? YEAR : MONTH_OF_YEAR;
                return i;
            }
        }
    ...
    public LocalDateTime plus(ReadableDuration readableDuration) {
        return withDurationAdded(readableDuration, MONTH_OF_YEAR);
    }
