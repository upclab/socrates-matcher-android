...
public abstract class DateTimeFieldType implements Serializable {
    ...
    static {
        ERA_TYPE = new StandardDateTimeFieldType("era", ERA, DurationFieldType.eras(), null);
        ...
        YEAR_OF_CENTURY_TYPE = new StandardDateTimeFieldType("yearOfCentury", YEAR_OF_CENTURY, DurationFieldType.years(), DurationFieldType.centuries());
        ...
        CLOCKHOUR_OF_DAY_TYPE = new StandardDateTimeFieldType("clockhourOfDay", CLOCKHOUR_OF_DAY, DurationFieldType.hours(), DurationFieldType.days());
