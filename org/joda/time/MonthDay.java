...
public final class MonthDay extends BasePartial implements ReadablePartial, Serializable {
    ...
    public static MonthDay fromCalendarFields(Calendar calendar) {
        if (calendar != null) {
            return new MonthDay(calendar.get(2) + DAY_OF_MONTH, calendar.get(5));
        }
    ...
    public static MonthDay fromDateFields(Date date) {
        if (date != null) {
            return new MonthDay(date.getMonth() + DAY_OF_MONTH, date.getDate());
        }
    ...
    public MonthDay withPeriodAdded(ReadablePeriod readablePeriod, int i) {
        ...
        for (int i2 = MONTH_OF_YEAR; i2 < readablePeriod.size(); i2 += DAY_OF_MONTH) {
    ...
    public MonthDay plus(ReadablePeriod readablePeriod) {
        return withPeriodAdded(readablePeriod, DAY_OF_MONTH);
    }
    ...
    public MonthDay withMonthOfYear(int i) {
        return new MonthDay(this, getChronology().monthOfYear().set(this, MONTH_OF_YEAR, getValues(), i));
    }

    public MonthDay withDayOfMonth(int i) {
        return new MonthDay(this, getChronology().dayOfMonth().set(this, DAY_OF_MONTH, getValues(), i));
    }
