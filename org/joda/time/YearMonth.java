...
public final class YearMonth extends BasePartial implements ReadablePartial, Serializable {
    ...
    public static YearMonth fromCalendarFields(Calendar calendar) {
        if (calendar != null) {
            return new YearMonth(calendar.get(MONTH_OF_YEAR), calendar.get(2) + MONTH_OF_YEAR);
        }
    ...
    public static YearMonth fromDateFields(Date date) {
        if (date != null) {
            return new YearMonth(date.getYear() + 1900, date.getMonth() + MONTH_OF_YEAR);
        }
    ...
    public Interval toInterval(DateTimeZone dateTimeZone) {
        ...
        return new Interval(toLocalDate(MONTH_OF_YEAR).toDateTimeAtStartOfDay(zone), plusMonths(MONTH_OF_YEAR).toLocalDate(MONTH_OF_YEAR).toDateTimeAtStartOfDay(zone));
    }
    ...
    public YearMonth withYear(int i) {
        return new YearMonth(this, getChronology().year().set(this, YEAR, getValues(), i));
    }

    public YearMonth withMonthOfYear(int i) {
        return new YearMonth(this, getChronology().monthOfYear().set(this, MONTH_OF_YEAR, getValues(), i));
    }
