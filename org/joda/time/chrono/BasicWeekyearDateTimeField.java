...
final class BasicWeekyearDateTimeField extends ImpreciseDateTimeField {
    ...
    public long set(long j, int i) {
        ...
        return this.iChronology.dayOfWeek().set(year + (((long) (i2 - this.iChronology.getWeekOfWeekyear(year))) * 604800000), dayOfWeek);
    }
    ...
    public long roundFloor(long j) {
        ...
        if (weekOfWeekyear > 1) {
            return roundFloor - (604800000 * ((long) (weekOfWeekyear - 1)));
        }
        return roundFloor;
    }
