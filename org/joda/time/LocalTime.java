...
public final class LocalTime extends BaseLocal implements ReadablePartial, Serializable {
    ...
    static {
        MIDNIGHT = new LocalTime(HOUR_OF_DAY, HOUR_OF_DAY, HOUR_OF_DAY, HOUR_OF_DAY);
    ...
    public LocalTime(Object obj, DateTimeZone dateTimeZone) {
        ...
        this.iLocalMillis = this.iChronology.getDateTimeMillis(0, partialValues[HOUR_OF_DAY], partialValues[MINUTE_OF_HOUR], partialValues[SECOND_OF_MINUTE], partialValues[MILLIS_OF_SECOND]);
    }
    ...
    public LocalTime(int i, int i2) {
        this(i, i2, HOUR_OF_DAY, HOUR_OF_DAY, ISOChronology.getInstanceUTC());
    }

    public LocalTime(int i, int i2, int i3) {
        this(i, i2, i3, HOUR_OF_DAY, ISOChronology.getInstanceUTC());
    }
    ...
    public int compareTo(ReadablePartial readablePartial) {
        ...
        if (readablePartial instanceof LocalTime) {
            ...
            if (this.iChronology.equals(localTime.iChronology)) {
                int i = this.iLocalMillis < localTime.iLocalMillis ? -1 : this.iLocalMillis == localTime.iLocalMillis ? HOUR_OF_DAY : MINUTE_OF_HOUR;
                return i;
            }
        }
