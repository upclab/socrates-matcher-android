...
public class IllegalInstantException extends IllegalArgumentException {
    ...
    private static String createMessage(long j, String str) {
        return "Illegal instant due to time zone offset transition (daylight savings time 'gap'): " + DateTimeFormat.forPattern("yyyy-MM-dd'T'HH:mm:ss.SSS").print(new Instant(j)) + (str != null ? " (" + str + ")" : StringUtils.EMPTY);
    }
