...
public class ISODateTimeFormat {
    ...
    static final class Constants {
        ...
        private static final DateTimeFormatter f68t;
        ...
        private static DateTimeFormatter timeElementParser() {
            ...
            DateTimeParser toParser = new DateTimeFormatterBuilder().append(null, new DateTimeParser[]{new DateTimeFormatterBuilder().appendLiteral((char) ClassUtils.PACKAGE_SEPARATOR_CHAR).toParser(), new DateTimeFormatterBuilder().appendLiteral(',').toParser()}).toParser();
