...
public class DateTimeFormatter {
    ...
    public int parseInto(ReadWritableInstant readWritableInstant, String str, int i) {
        ...
        DateTimeParserBucket dateTimeParserBucket = new DateTimeParserBucket(offset, chronology, this.iLocale, this.iPivotYear, i2);
        ...
        if (this.iOffsetParsed && dateTimeParserBucket.getOffsetInteger() != null) {
            chronology = chronology.withZone(DateTimeZone.forOffsetMillis(dateTimeParserBucket.getOffsetInteger().intValue()));
