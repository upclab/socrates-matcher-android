...
public class DateTimeComparator implements Comparator<Object>, Serializable {
    ...
    public String toString() {
        if (this.iLowerLimit == this.iUpperLimit) {
            return "DateTimeComparator[" + (this.iLowerLimit == null ? StringUtils.EMPTY : this.iLowerLimit.getName()) + "]";
        }
        return "DateTimeComparator[" + (this.iLowerLimit == null ? StringUtils.EMPTY : this.iLowerLimit.getName()) + "-" + (this.iUpperLimit == null ? StringUtils.EMPTY : this.iUpperLimit.getName()) + "]";
    }
}
