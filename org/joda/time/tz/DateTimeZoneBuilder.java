...
public class DateTimeZoneBuilder {
    ...
    private static final class RuleSet {
        ...
        public org.joda.time.tz.DateTimeZoneBuilder.Transition firstTransition(long r9) {
            /*
            r8 = this;
            r0 = r8.iInitialNameKey;
            if (r0 == 0) goto L_0x0015;
        L_0x0004:
            r0 = new org.joda.time.tz.DateTimeZoneBuilder$Transition;
            r3 = r8.iInitialNameKey;
            r1 = r8.iStandardOffset;
            r2 = r8.iInitialSaveMillis;
            r4 = r1 + r2;
            r5 = r8.iStandardOffset;
            r1 = r9;
            r0.<init>(r1, r3, r4, r5);
        L_0x0014:
            return r0;
    ...
    private static final class PrecalculatedZone extends DateTimeZone {
        ...
        static PrecalculatedZone readFrom(DataInput dataInput, String str) throws IOException {
            ...
            for (i = 0; i < readInt; i++) {
                ...
                if (readUnsignedShort < AccessibilityEventCompat.TYPE_VIEW_HOVER_EXIT) {
                    try {
        ...
        static PrecalculatedZone create(String str, boolean z, ArrayList<Transition> arrayList, DSTZone dSTZone) {
            ...
            while (i3 < strArr.length - 1) {
                ...
                long j = (long) iArr[i3];
                long j2 = (long) iArr[i3 + 1];
                long j3 = (long) iArr2[i3];
                long j4 = (long) iArr2[i3 + 1];
                ...
                if (j != j2 && j3 == j4 && str3.equals(str4) && period.getYears() == 0 && period.getMonths() > 4 && period.getMonths() < 8 && str3.equals(objArr[2]) && str3.equals(objArr[4])) {
                    ...
                    if (j > j2) {
                        strArr[i3] = (str3 + "-Summer").intern();
                    } else if (j < j2) {
                        strArr[i3 + 1] = (str4 + "-Summer").intern();
                        i3++;
                    }
                }
                i3++;
            ...
            for (i2 = 0; i2 < length; i2++) {
                ...
                while (i < size) {
                    if (strArr[i].equals(obj)) {
                        if (size < AccessibilityEventCompat.TYPE_VIEW_HOVER_EXIT) {
    ...
    static void writeMillis(DataOutput dataOutput, long j) throws IOException {
        ...
        if (j % DateUtils.MILLIS_PER_MINUTE == 0) {
            j2 = j / DateUtils.MILLIS_PER_MINUTE;
            if (((j2 << 34) >> 34) == j2) {
        ...
        if (j % 1000 == 0) {
            j2 = j / 1000;
            if (((j2 << 26) >> 26) == j2) {
                dataOutput.writeByte(((int) ((j2 >> 32) & 63)) | AccessibilityEventCompat.TYPE_VIEW_HOVER_ENTER);
    ...
    static long readMillis(DataInput dataInput) throws IOException {
        ...
        switch (readUnsignedByte >> 6) {
            case Value.TYPE_FIELD_NUMBER /*1*/:
                return ((long) (((((readUnsignedByte << 26) >> 2) | (dataInput.readUnsignedByte() << 16)) | (dataInput.readUnsignedByte() << 8)) | dataInput.readUnsignedByte())) * DateUtils.MILLIS_PER_MINUTE;
    ...
    L_0x001a:
        r0 = r12.iRuleSets;
        r0 = r0.get(r5);
        r0 = (org.joda.time.tz.DateTimeZoneBuilder.RuleSet) r0;
        r9 = r0.firstTransition(r1);
    ...
    L_0x0029:
        ...
        goto L_0x0018;
    L_0x002f:
        r12.addTransition(r7, r9);
        r2 = r9.getMillis();
        r1 = r9.getSaveMillis();
        r9 = new org.joda.time.tz.DateTimeZoneBuilder$RuleSet;
        r9.<init>(r0);
        r0 = r1;
        r10 = r2;
        r1 = r10;
        r3 = r4;
    L_0x0043:
        r4 = r9.nextTransition(r1, r0);
        if (r4 == 0) goto L_0x0051;
    L_0x0049:
        r1 = r12.addTransition(r7, r4);
        if (r1 == 0) goto L_0x0057;
    L_0x004f:
        if (r3 == 0) goto L_0x0057;
    L_0x0051:
        r0 = r9.getUpperLimit(r0);
        r4 = r3;
        goto L_0x0029;
    L_0x0057:
        r1 = r4.getMillis();
    ...
    L_0x0073:
        r0 = "UTC";
        r4 = buildFixedZone(r13, r0, r6, r6);
        goto L_0x0072;
    L_0x007a:
        r0 = r7.size();
        r1 = 1;
    ...
    L_0x0083:
        r0 = r7.get(r6);
        r0 = (org.joda.time.tz.DateTimeZoneBuilder.Transition) r0;
        r1 = r0.getNameKey();
        r2 = r0.getWallOffset();
        r0 = r0.getStandardOffset();
        r4 = buildFixedZone(r13, r1, r2, r0);
        goto L_0x0072;
    L_0x009a:
        r4 = org.joda.time.tz.DateTimeZoneBuilder.PrecalculatedZone.create(r13, r14, r7, r4);
        r0 = r4.isCachable();
        if (r0 == 0) goto L_0x0072;
    L_0x00a4:
        r4 = org.joda.time.tz.CachedDateTimeZone.forZone(r4);
        goto L_0x0072;
        */
    ...
    public void writeTo(String str, OutputStream outputStream) throws IOException {
        if (outputStream instanceof DataOutput) {
            ...
            writeTo(str, new DataOutputStream(outputStream));
        }
    }
