...
public class NumberUtils {
    ...
    static {
        LONG_ZERO = Long.valueOf(0);
        LONG_ONE = Long.valueOf(1);
        LONG_MINUS_ONE = Long.valueOf(-1);
        ...
        FLOAT_ONE = Float.valueOf(AugmentedReality.ONE_PERCENT);
        FLOAT_MINUS_ONE = Float.valueOf(GroundOverlayOptions.NO_DIMENSION);
    }
    ...
    public static Number createNumber(String str) throws NumberFormatException {
        ...
        if (StringUtils.isBlank(str)) {
            ...
            int expPos = (str.indexOf(ServingValue.EXT_FIELD_NUMBER) + str.indexOf(69)) + 1;
            if (decPos > -1) {
                if (expPos <= -1) {
    ...
    public static boolean isNumber(java.lang.String r15) {
        ...
        r8 = 1;
        r9 = 0;
        r10 = org.apache.commons.lang3.StringUtils.isEmpty(r15);
